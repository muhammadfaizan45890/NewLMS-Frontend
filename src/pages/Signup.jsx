...
import { Eye, EyeOff, Loader2, User, Mail, Lock, Shield, CheckCircle, XCircle } from "lucide-react";
...
const Signup = () => {
  ...
  // Grayscale password strength colors
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              Join IntelHub and get started today
            </p>
          </div>
