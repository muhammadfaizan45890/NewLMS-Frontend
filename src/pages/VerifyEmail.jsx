...
import { Alert, AlertDescription } from '@/components/ui/alert';
import { Loader2, Mail, RefreshCw, ArrowLeft, ShieldCheck } from 'lucide-react';
import { toast } from 'sonner';
import { Link, useNavigate, useLocation } from 'react-router-dom';
import axios from 'axios';
import API from '@/utils/api';
      ...
      <div className="relative w-full max-w-md space-y-8">
        ...
        <Card className="w-full border border-gray-200 dark:border-gray-800 shadow-sm bg-white dark:bg-black">
          ...
          <CardContent className="space-y-4">
            ...
            {/* ===== NEW: Admin verification assistance ===== */}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-blue-600 dark:text-blue-400">
                    ...
                    <strong>contact the admin</strong> to manually verify your account.
                  </p>
                  <p className="text-xs text-blue-500 dark:text-blue-500 mt-1">
                    Admins can verify your email within 24 hours or manually approve it upon request.
                  </p>
                  <div className="mt-2">
                    <a
                      href="mailto:admin@yourdomain.com?subject=Email%20Verification%20Help"
